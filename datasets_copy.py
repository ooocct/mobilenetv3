...
def build_Odo_dataset(Data_frequency,Input_dim,device):
    ...
    # full_data_in = data_in1.append(data_in2.iloc[0:eval_size_in])
    test_data_in = data_in2.iloc[eval_size_in:]
    eval_size_out = int(len(data_out2) * 0.5)
    full_data_out = pd.concat([data_out1] * 6 + [data_out2.iloc[0:eval_size_out]] * 6 + [data_out3] * 6)
    # full_data_out = data_out1.append(data_out2.iloc[1:eval_size_out])
    ...
    full_arr_in = torch.cat([data_in1, data_in1_2, data_in1_3, data_in1_4, data_in1_5, data_in1_6,data_in2,data_in2_2,data_in2_3,data_in2_4,data_in2_5,data_in2_6,data_in3,data_in3_2,data_in3_3,data_in3_4,data_in3_5,data_in3_6], dim=0)
